  ...
  return (
    <>
      ...
      <Section title="State Tree">
        <img src={`${baseUrl}western_hemlock.jpg`} alt="A Western Hemlock tree standing proud with it's needled, evergreen form in the sunlight." />
      ...
      <Section title="Other trees in Washington">
        <img src={`${baseUrl}douglas_fir.jpg`} alt="A Douglas Fir tree in the sunlight." />
        ...
        <img src={`${baseUrl}western_red_cedar.jpg`} alt="A Western Red Cedar tree." />
        ...
        <img src={`${baseUrl}sitka_spruce.jpg`} alt="A Sitka Spruce standing on it's lonesome." />
        ...
        <img src={`${baseUrl}ponderosa_pine.jpg`} alt="A patch of Ponderosa Pines." />
